      ...
      <section className="py-[3rem] sm:py-[5rem] bg-gradient-to-br from-[#FFB703] to-[#FB8500] text-[#003049] sm:text-white">
        <div className="wrapper text-center">
          <div data-aos="fade-up" className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="bg-[#003049]/15 backdrop-blur-sm rounded-2xl p-4 sm:p-8 mt-8 border border-[#003049]/20">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 text-center">
                <div className="space-y-4 p-4 sm:p-6 bg-[#003049] backdrop-blur rounded-xl border border-[#003049]/40">
                  <h3 className="text-lg sm:text-xl font-semibold text-red-300">Current Monthly Costs</h3>
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-red-200">Customer Service Staff</p>
                      <p className="text-xl sm:text-2xl font-bold text-white">₹5,00,000</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-red-200">Manual Processing</p>
                ...
                <div className="space-y-4 p-4 sm:p-6 bg-[#003049] backdrop-blur rounded-xl border border-[#003049]/40">
                  <h3 className="text-lg sm:text-xl font-semibold text-white">With AI Automation</h3>
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-blue-200">75% Cost Reduction</p>
                      <p className="text-xl sm:text-2xl font-bold text-green-300">₹2,00,000 Saved</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-blue-200">24/7 Availability</p>
                ...
                <div className="space-y-4 p-4 sm:p-6 bg-[#003049] backdrop-blur rounded-xl border border-[#003049]/40">
                  <h3 className="text-lg sm:text-xl font-semibold text-yellow-300">Annual Savings</h3>
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-yellow-200">Total Cost Reduction</p>
                      <p className="text-2xl sm:text-3xl font-bold text-white">₹24,00,000</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs sm:text-sm text-yellow-200">ROI Timeline</p>
              ...
              <div className="mt-6 sm:mt-8 pt-6 border-t border-[#003049]/30">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-md mx-auto">
                  <Link to="/contact-us" className="bg-[#003049] text-white hover:bg-[#003049]/90 px-4 sm:px-6 py-3 rounded-xl font-semibold transition-colors shadow-lg hover:shadow-xl">
                    Get Custom ROI Analysis
                  </Link>
                  <Link to="/services" className="bg-[#003049]/80 hover:bg-[#003049] border border-[#003049] text-white px-4 sm:px-6 py-3 rounded-xl font-semibold transition-colors backdrop-blur-sm">
                    View AI Services
                  </Link>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-6 sm:mt-8 text-xs sm:text-sm">
              <div className="space-y-1 p-3 bg-[#003049] backdrop-blur rounded-lg border border-[#003049]/40">
                <p className="font-semibold text-white">Implementation</p>
                <p className="text-blue-200">2-16 weeks</p>
              </div>
              <div className="space-y-1 p-3 bg-[#003049] backdrop-blur rounded-lg border border-[#003049]/40">
                <p className="font-semibold text-white">Support</p>
                <p className="text-blue-200">24/7 monitoring</p>
              </div>
              <div className="space-y-1 p-3 bg-[#003049] backdrop-blur rounded-lg border border-[#003049]/40">
                <p className="font-semibold text-white">Scalability</p>
                <p className="text-blue-200">Enterprise ready</p>
              </div>
              <div className="space-y-1 p-3 bg-[#003049] backdrop-blur rounded-lg border border-[#003049]/40">
                <p className="font-semibold text-white">Compliance</p>
                <p className="text-blue-200">HIPAA, GDPR ready</p>
              </div>
            </div>
          </div>
        </div>
